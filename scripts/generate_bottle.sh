...
echo "class EosioCdt < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/an-ivannikov-dev/eosio.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/an-ivannikov-dev/eosio.cdt/releases/download/v${VERSION}\"
